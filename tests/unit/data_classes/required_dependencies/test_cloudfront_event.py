...
def test_cloudfront_viewer_request_event():
    ...
    assert parsed_event.record.cf_config.distribution_domain_name == "d111111abcdef8.cloudfront.net"
    ...
    assert parsed_event.record.cf_config.request_id == "4TyzHTaYWb1GX1qTfsHhEqV6HUDd_BzoBZnwfnvQc_1oF26ClkoUSEQ=="
    ...
    with pytest.raises(KeyError):
        assert parsed_event.record.cf_request.body
